...
const Chem = () => {
    ...
    return (
        <div className=' mx-20 grid grid-cols-1 lg:grid-cols-4 gap-6'>
            {/* Book Info Section */}
            <div
            ...
            >
                ...
                <div className='bg-yellow-800 cursor-default shadow-xl shadow-yellow-800/50 rounded-xl m-4 p-4'>
                    ...
                    {title === 'كيمياء' && <div>
                        <h4 className='  font-arabicUI3 my-3 rtl mx-auto mt-4 mb-2 justify-center text-center flex text-4xl text-yellow-800 bg-paton bg-cover p-4 rounded-xl '
                        >
