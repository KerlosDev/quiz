...
const Header = () => {
    ...
    return (
        <div className="flex flex-col relative md:flex-row items-center justify-between gap-4 p-4">

            <div className=' absolute w-80 h-80 dark:bg-slate-900 right-56 top-8 rounded-full blur-2xl -z-20'></div>
            {/* Theme Toggle */}
