            ...
            {user ? (
                <>
                    <div className='bg-yellow-400 rounded-xl lg:rounded-l-xl bg-paton bg-cover rouxl p-4 lg:p-8'>
                        ...
                        <div>
                            <h3 className='backdrop-blur-sm m-4 p-4 text-xl md:text-2xl lg:text-4xl place-items-center  rounded-xl bg-white font-arabicUI3 flex justify-center gap-2' dir='rtl'> حط كود صحبك <FaUserFriends /></h3>
                ...
                <div className='bg-yellow-400 rounded-xl lg:rounded-l-xl bg-paton bg-cover rouxl p-4 lg:p-8'>
                    <h4 className='text-center text-5xl leading-relaxed border-4 border-black rounded-xl bg-black/20 font-arabicUI3'>يرجى إنشاء حساب أولاً</h4>
                </div>
            )}
        </>
