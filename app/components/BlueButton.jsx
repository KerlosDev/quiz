...
const BlueButton = ({ title, number, handleClick,font = "font-arabicUI2" }) => {
    return (
        <div
            onClick={() => handleClick(title, number)}
            className={`hover:scale-110 m-4  h-40 place-items-center justify-center bg-opacity-50 text-white text-2xl sm:text-3xl lg:text-4xl ${font} transition duration-300 bg-non3 bg-cover gap-2 py-5 rounded-xl cursor-pointer`}
        >
