...
const Arabic = () => {
    ...
    const chemData = () => {
        GlobalApi.arabicData("ar")
            ...
            .catch((err) => {
                console.error("Error fetching Arabic data:", err);
            });
    };
    ...
    return (
        <div className='mx-4 sm:mx-8 lg:mx-20 grid grid-cols-1 lg:grid-cols-4 gap-6'>
            ...
            <div className="grid grid-cols-1 p-5 sm:grid-cols-2 lg:grid-cols-2 h-fit gap-6 lg:col-span-2">
                <RedButton handleClick={() => handleClick("شوامل 1", 1)} title="شوامل 1" number={1} ></RedButton>
                <YellowButton handleClick={() => handleClick("شوامل 2", 2)} title="شوامل 2" number={2} ></YellowButton>
                <GreenButton handleClick={() => handleClick("شوامل 3", 3)} title="شوامل 3" number={3} ></GreenButton>
            </div>
        </div>
    );
};
