...
const ActiveSqu = () => {
    ...
    return (
        <div>
            <div className="relative col-span-1 hover:brightness-90 transition bg-green-500 shadow-2xl h-full bg-non2 bg-cover outline-dashed outline-offset-2 outline-green-500 w-fit p-4 md:p-9 rounded-xl flex items-center">
                {/* Noise Effect */}
