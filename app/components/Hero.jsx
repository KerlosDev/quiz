...
const Hero = () => {
  ...
  return (
    <div className="relative selection:text-yellow-400 selection:bg-yellow-800 flex flex-col justify-center items-center px-4 sm:px-6 lg:px-8">
      {/* Main Hero Section */}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 m-8 gap-4">
        ...
        {/* Right Section */}
        <div className="shadow-2xl shadow-yellow-400/70 lg:mx-8 outline-dashed outline-offset-2 outline-yellow-300 bg-yellow-400 p-6 rounded-xl">
          <h1 className="font-arabicUI2 m-auto flex justify-center text-yellow-800 text-3xl md:text-5xl">
            <FaClipboardList />
            لوحة الشرف
          </h1>
          <div className="mt-6">
            {names.map((item, index) => (
              <div
                key={index}
                className="bg-yellow-600 p-3 flex justify-between mt-4 font-arabicUI2 rounded-xl text-xl md:text-2xl text-white"
              >
                <h3>
