    ...
    return (
        <div className='mx-4 sm:mx-8 lg:mx-20 grid grid-cols-1 lg:grid-cols-4 gap-6'>
            ...
            <div className="grid grid-cols-1 p-5 sm:grid-cols-2 lg:grid-cols-2 h-fit gap-6 lg:col-span-2">
                <div
                    onClick={() => handleClick(' من 1 لـ 10 شوامل', 1)}
                ...
                >
                    ...
                    <span className="text-5xl font-arabicUI3">من 1 لـ 10</span>
                </div>
                <div
                    onClick={() => handleClick(' من 11 لـ 20 شوامل', 2)}
                    className="hover:scale-110 m-4 font-arabicUI2 h-40 place-items-center justify-center bg-opacity-50 text-white text-2xl sm:text-3xl lg:text-4xl font-bold transition duration-300 bg-non bg-cover gap-2 py-5 rounded-xl cursor-pointer"
                >
                    <span className="m-auto flex justify-center">
                        <svg xmlns="http://www.w3.org/2000/svg" width={50} height={50} viewBox="0 0 24 24">
                    ...
                    <span className="text-5xl font-arabicUI3">من 11 لـ 20</span>
                </div>
                <div
                    onClick={() => handleClick(' من 21 لـ 30 شوامل', 3)}
                    className="hover:scale-110 m-4 font-arabicUI2 h-40 place-items-center justify-center bg-opacity-50 text-white text-2xl sm:text-3xl lg:text-4xl font-bold transition duration-300 bg-non bg-cover gap-2 py-5 rounded-xl cursor-pointer"
                >
                    <span className="m-auto flex justify-center">
                        <svg xmlns="http://www.w3.org/2000/svg" width={50} height={50} viewBox="0 0 24 24">
                    ...
                    <span className="text-5xl font-arabicUI3">من 21 لـ 30</span>
                </div>
                <div
                    onClick={() => handleClick(' من 31 لـ 40 شوامل', 4)}
                ...
                >
                    ...
                    <span className="text-black font-arabicUI3 text-5xl">من 31 لـ 40</span>
                </div>
                <div
                    onClick={() => handleClick(' من 41 لـ 50 شوامل', 5)}
                ...
                >
                    ...
                    <span className="text-black font-arabicUI3 text-5xl">من 41 لـ 50</span>
                </div>



                <div
                    onClick={() => handleClick(' من 51 لـ 60 شوامل', 6)}
                ...
                >
                    ...
                    <span className="text-5xl font-arabicUI3">من 51 لـ 60</span>
                </div>
                <div
                    onClick={() => handleClick(' من 61 لـ 67 شوامل', 7)}
                    className="hover:scale-110 m-4 font-arabicUI2 h-40 place-items-center justify-center bg-opacity-50 text-white text-2xl sm:text-3xl lg:text-4xl font-bold transition duration-300 bg-non2 bg-cover gap-2 py-5 rounded-xl cursor-pointer"
                >
                    <span className="m-auto flex justify-center">
                        <svg xmlns="http://www.w3.org/2000/svg" width={50} height={50} viewBox="0 0 24 24">
                    ...
                    <span className="text-5xl font-arabicUI3">من 61 لـ 67</span>
                </div>
